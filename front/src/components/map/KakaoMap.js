    ...
    >
      ...
      {tabIdx === 1 &&
        storeList.map((store, index) => {
          return <SmallMarker store={store} index={index} key={store.name + index} />;
        })}
      {tabIdx === 1 &&
        foodList.map((store, index) => {
          return (
            <NormalMarker store={store} index={index} key={store.name + index + 'food'} />
          );
        })}
      {tabIdx === 2 &&
        bookmarkList.map((store, index) => {
          return <SmallMarker store={store} index={index} key={store.name + index} />;
        })}
    </Map>
  );
